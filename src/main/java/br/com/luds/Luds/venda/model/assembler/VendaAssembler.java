...
public class VendaAssembler implements ILudzAssembler<Venda, VendaDTO, VendaForm> {
    ...
    public Venda assembleEntity(VendaForm vendaForm) {
        List<VendaItemCardapio> itemCardapioList = new ArrayList<>();
        return new Venda(null, null, vendaForm.getData(), vendaForm.getOrigem(), vendaForm.getValor(), itemCardapioList);
    }
}
